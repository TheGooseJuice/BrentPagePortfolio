class mainScene extends Phaser.Scene {
    ...
    this.monstro = this.physics.add.sprite( window.innerWidth + 100, window.innerHeight + 100, 'Casa1').play('monstro').setImmovable(true);
...
treasureHit(){
    if(Phaser.Geom.Intersects.RectangleToRectangle(this.player.getBounds(), this.treasure.getBounds())&&!this.dead&&this.start == true){
        ...
        this.stars += 1;
        this.score += 50;
        this.treasure.x = (window.innerHeight * 2);
